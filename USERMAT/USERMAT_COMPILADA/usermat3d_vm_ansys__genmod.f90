        ...
        MODULE USERMAT3D_VM_ANSYS__genmod
          INTERFACE 
            SUBROUTINE USERMAT3D_VM_ANSYS(MATID,ELEMID,KDOMINTPT,KLAYER,&
     &KSECTPT,LDSTEP,ISUBST,KEYCUT,NDIRECT,NSHEAR,NCOMP,NSTATEV,NPROP,  &
     &TIME,DTIME,TEMP,DTEMP,STRESS,USTATEV,DSDEPL,SEDEL,SEDPL,EPSEQ,    &
     &STRAIN,DSTRAIN,EPSPL,PROP,COORDS,VAR0,DEFGRAD_T,DEFGRAD,TSSTIF,   &
     &EPSZZ,CUTFACTOR,VAR1,VAR2,VAR3,VAR4,VAR5,VAR6,VAR7)
              ...
              REAL(KIND=8) :: VAR6
              REAL(KIND=8) :: VAR7
            END SUBROUTINE USERMAT3D_VM_ANSYS
          END INTERFACE 
        END MODULE USERMAT3D_VM_ANSYS__genmod
