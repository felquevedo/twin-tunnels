        ...
        MODULE USERMAT3D_ELASTICO__genmod
          INTERFACE 
            SUBROUTINE USERMAT3D_ELASTICO(MATID,ELEMID,KDOMINTPT,KLAYER,&
     ...
     &EPSZZ,CUTFACTOR,VAR1,VAR2,VAR3,VAR4,VAR5,VAR6,VAR7)
              ...
              REAL(KIND=8) :: VAR6
              REAL(KIND=8) :: VAR7
            END SUBROUTINE USERMAT3D_ELASTICO
          END INTERFACE 
        END MODULE USERMAT3D_ELASTICO__genmod
