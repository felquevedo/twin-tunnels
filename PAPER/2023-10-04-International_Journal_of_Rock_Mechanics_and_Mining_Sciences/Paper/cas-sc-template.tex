...
\begin{table}
	...
	\end{tabular}
	\normalsize
	\\ \footnotemark[2]{{\footnotesize $h_i= [R_i^2 - (R_i-e_i)^2]/(R_i-e_i)$ where $i = t$ for longitudinal tunnel or $i=g$ for gallery  circular cross-section with internal perimeter in contact with atmosphere.}}
\end{table}
\FloatBarrier
