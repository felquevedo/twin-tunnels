...
To develop the parametric analyses, we utilized the constitutive parameters of the Callovo-Oxfordian clay rock mass as outlined in Piepi [\citenum{piepi1995}], and for the lining, we employed typical values for ordinary reinforced concrete. These parameters are shown in Table~\ref{table2}. In these analyses the radius is $R_i = 1$ m and excavation speed is 12.5 m/day.
\begin{table}
