...
Fig.~\ref{Tangencial stress concentration factor in A} shows the analytical and numerical solutions of Guo et al [\citenum{GUO2021}] together with the results obtained with the current 3D model. Ling's solution [\citenum{ling1948}], employed by these researchers to validate their analytical and numerical approaches, is also shown. Extra analyses with $d_1/2R_t = 4$ and $5$ show that, as the longitudinal tunnels become increasingly spaced apart, the solution converges to that of a single tunnel.
...
\begin{figure}[h!]
	...
	\caption{Verification of numerical results of tangencial stresses with the analytical solution in elasticity.}
	\label{GUO_FIG1}
\end{figure}
\FloatBarrier
