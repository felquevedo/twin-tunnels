...
Some recent studies on deep twin tunnels can be found at [\citenum{Fortsakis2021}, \citenum{Spyridis2015}, \citenum{chortis2021}]
...
To develop the parametric analyses, we utilized the constitutive parameters of the rock mass as outlined in Piepi [\citenum{piepi1995}], and for the lining, we employed typical values for ordinary reinforced concrete. These parameters are shown in Table~\ref{table2}.
\begin{table}
