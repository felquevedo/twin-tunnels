...
The elastoplastic-viscoplastic model, with infinitesimal transformation hypotesis, is formulated from the serial association of the plastic and viscoplastic constitutive models, i.e. $\dstrain = \dstraine + \dstrainp + \dstrainv$, which leads to the following linear constitutive relationship:
