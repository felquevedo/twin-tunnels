...
% Short title
\shorttitle{Twin tunnels with galleries using plastic and viscous models}    
...
\begin{highlights}
	...
	\item Interaction between the tunnels becomes significant at a span distance of 4 radius
	\item The viscous of the concrete lining can be important in the tunnel convergence
	\item The effect of the gallery extends into the tunnel up to 4 radius from its axis
