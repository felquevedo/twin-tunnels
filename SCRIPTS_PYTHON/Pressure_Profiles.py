...
#%% PRESSURE PROFILES - FIXED MODEL VARIOUS D1
""" ********************************************
PRESSURE PROFILES - FIXED MODEL VARIOUS D1
******************************************** """

#%% #.  PRESSURE PROFILES - MODEL E_CRE_CG
""" ********************************************
PRESSURE PROFILES - MODEL E_CRE_CG
******************************************** """ 
...
figura      = figura+1
titulo      = 'Pressure Profiles - E_CRE_CG'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile 
ymax        = ymax_twin_pressure_profile+5 
...
#%% #.  PRESSURE PROFILES - MODEL EP_SR_SG
""" ********************************************
PRESSURE PROFILES - MODEL EP_SR_SG
******************************************** """ 
...
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - EP_SR_SG'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile+1
xmin        = xmin_twin_profile
xmax        = xmax_twin_profile
invertx     = True
inserirx0   = True
...
#%% #.  PRESSURE PROFILES - MODEL EP_SR_CG
""" ********************************************
PRESSURE PROFILES - MODEL EP_SR_CG
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EP_SR_CG'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile+1
...
#%% #.  PRESSURE PROFILES - MODEL EP_CRE_SG
""" ********************************************
PRESSURE PROFILES - MODEL EP_CRE
******************************************** """ 

# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - EP_CRE_SG'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EP_CRE_CG
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EP_CRE_CG'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL VP_CRE_CG_ST
""" ********************************************
PRESSURE PROFILES - MODEL VP_CRE_CG_ST
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - VP_CRE_CG_ST'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL VP_CRE_CG_LT
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - VP_CRE_CG_LT'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRE_SG_ST
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRE_CG_ST
******************************************** """ 

# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRE_SG_ST'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRE_SG_LT
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRE_SG_LT
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRE_SG_LT'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRE_CG_ST'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRE_CG_LT
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRE_CG_LT'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
graficar(arquivo,titulo,eixox,eixoy,
          ...
          suavizar,filterx1,filterx2,wl,poly,
          figura)
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRVE_SG_ST
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRE_CG_ST
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRVE_SG_ST'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRVE_SG_LT
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRVE_SG_LT
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRVE_SG_LT'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRVE_CG_ST
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRE_CG_ST
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRVE_CG_ST'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #.  PRESSURE PROFILES - MODEL EPVP_CRVE_CG_LT
""" ********************************************
PRESSURE PROFILES - MODEL EPVP_CRVE_CG_LT
******************************************** """ 
...
# Formatação do gráfico
figura      = figura + 1
titulo      = 'Pressure Profiles - EPVP_CRVE_CG_LT'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_ST - D1=16Re
""" ********************************************
CONVERGENCE PROFILES - CRE_SG_ST - D1=16Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_ST - $d_1=16R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_LT - D1=16Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_LT - D1=16Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_LT - $d_1=16R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_CG_ST - D1=16Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_ST - D1=16Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_ST - $d_1=16R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_LT - $d_1=16R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_ST - D1=8Re
""" ********************************************
CONVERGENCE PROFILES - CRE_SG_ST - D1=8Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_ST - $d_1=8R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_LT - D1=8Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_LT - D1=8Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_LT - $d_1=8R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_CG_ST - D1=8Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_ST - D1=8Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_ST - $d_1=8R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_LT - $d_1=8R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_ST - D1=4Re
""" ********************************************
CONVERGENCE PROFILES - CRE_SG_ST - D1=4Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_ST - $d_1=4R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_SG_LT - D1=4Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_LT - D1=4Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_SG_LT - $d_1=4R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
#%% #. CONVERGENCE PROFILES - CRE_CG_ST - D1=4Re
""" ********************************************
CONVERGENCE PROFILES - CRE_CG_ST - D1=4Re
******************************************** """ 
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_ST - $d_1=4R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
...
# Formatação do gráfico
figura      = figura+1
titulo      = 'Pressure Profiles - CRE_CG_LT - $d_1=4R_e$'
eixox       = r'$x/R_e$'  
eixoy       = r'$U=-u(r = R_e,\theta = 90^\circ)/R_{e}$ [%]'
ymin        = ymin_twin_pressure_profile
ymax        = ymax_twin_pressure_profile
